      ...
      <div style="position:relative;overflow:hidden;border-radius:22px;background:var(--cc-hero-gradient);color:#fff;padding:14px 18px;box-shadow:var(--cc-hero-shadow)">
        ...
        <div style="position:relative;display:flex;align-items:flex-start;justify-content:space-between;gap:10px">
          <div style="min-width:0">
            <div style="font-size:10px;font-weight:700;letter-spacing:.6px;opacity:.9">GIÁM SÁT</div>
            <div style="font-size:20px;font-weight:700;margin-top:1px">Trưởng ca toàn chuỗi</div>
...
function tcGsRender(){
  ...
  if(ctr) ctr.innerHTML=`
    <div style="position:relative;margin-bottom:9px">
      ...
      <div id="tcgs-search-dd" style="display:none;position:absolute;top:calc(100% + 4px);left:0;right:0;background:#fff;border:1px solid #E2E8F0;border-radius:14px;box-shadow:0 12px 32px rgba(0,0,0,.18);max-height:240px;overflow-y:auto;z-index:20;padding:4px"></div>
